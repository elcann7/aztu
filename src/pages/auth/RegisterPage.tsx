...
export const RegisterPage: React.FC = () => {
  ...
  useEffect(() => {
    const activeClientId = (localStorage.getItem('aztu_google_client_id') || GOOGLE_CLIENT_ID || '').trim();
    ...
    const initGsi = () => {
      ...
      try {
        ...
        if (googleRegBtnRef.current) {
          googleRegBtnRef.current.innerHTML = '';
          window.google.accounts.id.renderButton(googleRegBtnRef.current, {
            type: 'standard',
            theme: 'outline',
            size: 'large',
            text: 'signup_with',
        ...
        console.error('GIS initialization error in RegisterPage:', err);
      }
    };
      ...
      <div className="auth-card-container register-card-container">
        ...
        {isRegistrationLocked ? (
          ...
          <>
            ...
            {/* Real Google GIS Button Container */}
