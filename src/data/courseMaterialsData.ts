...
export const BUILT_IN_MATERIALS: Material[] = [
  ...
  },
  {
    ...
    type: 'file',
    description:
      'KOICA LMS #8407 · Orijinal fayl: M5-6.pptx (26 slaydın tam qaydaları və PDF-i)',
    fileName: 'm5-6.pdf',
  ...
  // Müəllim: Dos. Rəna Əmirova (Cloudflare R2 PDF + Slaydlardan çıxarılmış qaydalar)
  // ==========================================================================
  {
    id: 'koica_alg_4234',
    ...
    type: 'file',
    description:
      '✓ Keçildi (1-ci həftə) · KOICA LMS #4234 · Orijinal fayl: dərs Müh1.pptx (21 slaydın tam qaydaları, AI nümunəsi və PDF-i)',
    fileName: 'muhazire-01.pdf',
  ...
  },
  {
    ...
    type: 'file',
    description:
      '✓ Keçildi (2-ci həftə) · KOICA LMS #4236 · Orijinal fayl: dərs Müh2.pptx (8 slaydın tam qaydaları, İqtisadiyyat, Kriptoqrafiya və PDF-i)',
    fileName: 'muhazire-02.pdf',
    fileSize: '2.2 MB · PDF + Qaydalar',
    fileMime: 'application/pdf',
