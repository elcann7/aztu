...
export const COURSE_SYLLABUS: Record<string, SyllabusWeek[]> = {
  ...
  prog: [
    ...
    { week: 2, dates: '22-26 Sen', title: 'Dəyişənlər, əsas məlumat tipləri (int, float, str, bool), tip çevrilmələri və riyazi operatorlar', type: 'lecture', status: 'in_progress', description: 'Lab Aud. 6-504 / Mühazirə Aud. 6-408' },
    ...
    { week: 13, dates: '08-12 Dek', title: 'Rekursiv funksiyalar, lambda funksiyaları, map() və filter() alətləri', type: 'lecture', status: 'upcoming' },
    { week: 14, dates: '15-19 Dek', title: '3-CÜ KOLLOQVİUM / SƏRBƏST İŞ & Fayllarla iş (open, read, write, with context manager)', type: 'colloquium', status: 'upcoming' },
    { week: 15, dates: '22-26 Dek', title: 'Xətaların idarə edilməsi (try-except) və Semestr Yekun İmtahana Hazırlıq Məsələləri', type: 'lecture', status: 'upcoming' },
  ],
  eng: [
...
export const FEATURED_LECTURES: Record<string, Lecture> = {
  ...
  prog: {
    ...
    teacherRemark:
      'Dos. Fizuli Əzimov: Python-da bloklar 4 boşluq (indentation) ilə təyin edilir. Şərtlərdə and, or, not məntiqi operatorlarının prioritetinə diqqət yetirin.',
    summary:
